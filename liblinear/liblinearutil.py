...
__all__ = ['svm_read_problem', 'load_model', 'save_model', 'evaluations',
           'train', 'predict','warm_start_train'] + liblinear_all
...
def warm_start_train(arg1, init_model, arg2=None, arg3=None):	
	...
	if param.flag_find_C:
		...
		m = liblinear.warm_start_train(prob, param, init_model)
		m = toPyModel(m)
